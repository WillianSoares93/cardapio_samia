        ...
        document.addEventListener('DOMContentLoaded', function() {
                ...
                if (selectedPaymentMethod) {
                    ...
                    if (radio) {
                        ...
                        if (methodValue === 'Pix' && contactInfo.chavepix) {
                            ...
                            const payload = gerarPayload(contactInfo.chavepix, totalAmount, contactInfo.nome, contactInfo.cidade, "pedido" + Date.now());
                            pixKeyDisplay.textContent = payload;
                            pixDetailsContainer.classList.remove('hidden');
            ...
            async function loadMenuAndRender() {
                try {
                    ...
                    populateContactInfo(parsedContactInfo);
